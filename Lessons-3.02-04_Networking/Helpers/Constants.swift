...
//
//  Created by Юрий Куринной on 07.09.2023.
//
...
struct Constants {
    ...
    static let contractTextVC = "ContractTextVC"
    static let contractWorksVC = "ContractWorksVC"
    static let contractorInfoVC = "ContractorInfoVC"
